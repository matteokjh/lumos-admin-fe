...
const SubmitRun = (props: SubmitRunProps) => {
    ...
    return (
        <div className="SubmitRun">
            {(result.judge === 2 && <div></div>) ||
                (result.judge === 6 && (
                    <div className="AC_box">
                        {/* 输入 */}
                        <div>
                            <p>输入：</p>
                            <div className="valueBox">{result.errObj?.input}</div>
                        </div>
                        {/* 输出 */}
                        <div>
                            <p>输出：</p>
                            <div className="valueBox">{result.errObj?.userOutput}</div>
                        </div>
                        {/* 预期结果 */}
                        <div>
                            <p>预期结果：</p>
                        ...
                        {result.errObj?.stdout && (
                            <div>
                                <p>stdout：</p>
                                <div className="valueBox">{result.errObj?.stdout}</div>
                            </div>
                        )}
                    </div>
                )) || (
